...
#define VERSION "0.18.1_C"						// Version of the software
...
IotWebConfParameter paramNumLeds = IotWebConfParameter("Number of LEDs (default: 8)", "numLeds", paramNumLedsValue, INTEGER_LEN, "number", "1..500", "8", "min='1' max='500' step='1'");
